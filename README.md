...
* podmínky (je-li přítomna část `WHERE`, příp. jde-li o tabulku reprezentující `JOIN`) v "atomárním tvaru", tzn. bez uvažování logických spojek, seskupení podmínek pomocí závorek apod.,
